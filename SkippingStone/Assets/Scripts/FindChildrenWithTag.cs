...
public static class FindChildrenWithTag {

    public static T[] FindChildGameObjectsWithTag<T>(this GameObject parent, string tag, bool forceActive = false) where T : Component
    {
